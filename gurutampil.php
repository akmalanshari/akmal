...
<table width="73%" border="0" cellspacing="0" cellpadding="0" id="product-table"  >
   <tr bgcolor="#99CC33">
  ...
  <?php
  $rw=mysqli_query($koneksi,"Select * from data_guru order by nama_guru asc");
...
{
	$ids=$_GET['id_guru'];
	$ff=mysqli_query($koneksi,"Delete from data_guru Where sha1(id_guru)='".$ids."'");
	if($ff)
	{
