...
if(isset($_POST['submit'])){
	...
	$query=mysqli_query($koneksi,"update tbl_jadwal set nama_pelajaran='$nama_pelajaran',kkm='$kkm',id_guru='$id_guru', kelas='$kelas' where id_jadwal='$id_jadwal'");
...
<!-- end page-heading -->
			<?php
			$jadwal=mysqli_fetch_array(mysqli_query($koneksi,"select * from tbl_jadwal where id_jadwal='$_GET[id_jadwal]'"));
	       ...
	       <?php // Koneksi 
						...
						$result = mysqli_query($koneksi,"select * from setup_pelajaran"); 
