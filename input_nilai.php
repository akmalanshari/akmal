...
if(isset($_GET['id_guru'])){
	...
	$query=mysqli_query($koneksi, "select * from tbl_nilai where id_guru='$id_guru' and kelas='$kelas' and id_jadwal='$id_jadwal'");
...
<tr>
    ...
    <div id="content-table-inner">
		...
		$view=mysqli_query($koneksi, "select * from tbl_jadwal where id_guru='$id_guru' order by id_jadwal asc");
