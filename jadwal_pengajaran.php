...
if(isset($_POST['submit'])){
	...
	$query=mysqli_query($koneksi,"insert into tbl_jadwal values('','$nama_pelajaran','$kkm','$id_guru','$kelas')");
...
<tr>
    ...
    <div id="content-table-inner">
	      ...
	      <?php // Koneksi 
						...
						mysqli_select_db($koneksi,"db_akademikk"); 
	   ...
	   <td><input type="hidden" name="kkm" id="prd_name" class="inp-form" /></td>
        ...
        <?php
		$view=mysqli_query($koneksi,"select * from tbl_jadwal jadwal, data_guru guru where jadwal.id_guru=guru.id_guru order by jadwal.id_jadwal asc");
