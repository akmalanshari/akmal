...
{
	$rs=mysqli_query($koneksi,"Select * from data_guru where sha1(id_guru)='".$_GET['id_guru']."'");
    ...
    <tr>
      ...
      <td>
        <input name="pendidikan" type="text" class="inp-form" id="pendidikan" maxlength="70" value="<?php echo $row['pendidikan']; ?>" /></td>
			...
			<?php
			$sql = mysqli_query($koneksi,"SELECT * FROM pegawai ORDER BY namapegawai ASC");
