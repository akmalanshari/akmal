...
{
	$rs=mysqli_query($koneksi,"Select * from data_siswa where sha1(id_siswa)='".$_GET['id_siswa']."'");
   ...
   <table width="772" height="1208" border="0">
    ...
    <tr>
	  ...
	  <select name="kelas" class="styledselect_form_1">
			...
			<?php
			include('conn.php');
			$sql = mysqli_query($koneksi,"SELECT * FROM setup_kelas ORDER BY nama_kelas ASC");
