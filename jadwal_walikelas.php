...
if(isset($_POST['submit'])){
	...
	$query=mysqli_query($koneksi ,"insert into tbl_jwalikelas values('','$nama_kelas','$jurusan','$id_guru','$nip')");
...
<tr>
    ...
    <div id="content-table-inner">
	      ...
	      <?php // Koneksi 
						...
						mysqli_select_db("db_akademikk"); 
						
						$result = mysqli_query($koneksi,"select * from setup_kelas"); 
	   ...
	   <td><input type="hidden" name="jurusan" id="prd_name" class="inp-form" /></td>
        ...
        <?php
		$view=mysqli_query($koneksi,"select * from tbl_jwalikelas jwalikelas, data_guru guru where jwalikelas.id_guru=guru.id_guru order by jwalikelas.id_jwalikelas asc");
		$no=0;
