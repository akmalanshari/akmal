...
<tr>
    ...
    <div id="content-table-inner">
		...
		$guru=mysqli_fetch_array(mysqli_query($koneksi,"select * from data_guru where id_guru='$id_guru'"));
		$kelas=mysqli_fetch_array(mysqli_query($koneksi,"select * from tbl_jadwal where kelas='$kelass'"));
		$pelajaran=mysqli_fetch_array(mysqli_query($koneksi,"select * from tbl_jadwal where id_jadwal='$id_jadwal'"));
      ...
      <br />
        ...
        <?php
		$view=mysqli_query($koneksi,"SELECT * FROM tbl_nilai nilai, data_siswa siswa WHERE nilai.id_siswa=siswa.id_siswa and nilai.id_guru='$id_guru' and nilai.kelas='$kelas' and nilai.id_jadwal='$id_jadwal' order by siswa.nama_siswa asc");
